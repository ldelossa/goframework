...
// will be made every sl.retry interval. Once lock is acquired the
// method unblocks
...
func (l *lock) TryLock(ctx context.Context, key string) (bool, error) {
	...
	// if acquired set lock status which unlocks caller waiting on Lock() method
